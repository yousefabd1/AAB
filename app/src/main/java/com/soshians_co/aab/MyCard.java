...
// title  and direction//
        ...
        getSupportActionBar().setTitle("کارت های من");
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.message:
                        ...
                        Intent intent2 = new Intent(MyCard.this, MessageInbox.class);
                        overridePendingTransition(0, 0);
                    ...
                    case R.id.trasaction:
                        item.setChecked(true);
                        drawerLayout.closeDrawers();
                        Intent intent3 = new Intent(MyCard.this, Transactions.class);
                        overridePendingTransition(0, 0);
                    ...
                    case R.id.myScor:
                        item.setChecked(true);
                        drawerLayout.closeDrawers();
                        Intent intent5 = new Intent(MyCard.this, MyScore.class);
                        overridePendingTransition(0, 0);
                    ...
                    case R.id.pony:
                        item.setChecked(true);
                        drawerLayout.closeDrawers();
                        Intent intent6 = new Intent(MyCard.this, Pony.class);
                        overridePendingTransition(0, 0);
                    ...
                    case R.id.myAccunt:
                        item.setChecked(true);
                        drawerLayout.closeDrawers();
                        Intent intent7 = new Intent(MyCard.this, UserAccount.class);
                        overridePendingTransition(0, 0);
                    ...
                    case R.id.setting:
                        item.setChecked(true);
                        drawerLayout.closeDrawers();
                        Intent intent8 = new Intent(MyCard.this, Settings.class);
                        overridePendingTransition(0, 0);
                    ...
                    case R.id.aboutUs:
                        item.setChecked(true);
                        drawerLayout.closeDrawers();
                        Intent intent9 = new Intent(MyCard.this, AboutUs.class);
                        overridePendingTransition(0, 0);
